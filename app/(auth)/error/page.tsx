  ...
  return (
    <div className="h-screen w-full flex flex-col lg:flex-row select-none bg-background overflow-hidden relative">
      ...
      <motion.div
        ...
        className="flex flex-col justify-between w-full lg:w-1/2 px-6 sm:px-12 lg:px-6 py-8 relative z-10 h-full overflow-y-auto scrollbar-none bg-linear-to-b from-rose-500/[0.12] via-background to-background backdrop-blur-sm border-r border-border/50"
      >
        {/* LOGO + BRAND */}
        <motion.div
      ...
      >
        ...
        <div className="relative z-10 w-full max-w-2xl text-center text-white space-y-12">
          ...
          <div className="space-y-6">
            ...
            >
              Reliable Property <br />
              <span className="text-transparent bg-clip-text bg-linear-to-r from-white to-white/60">Management.</span>
            </motion.h2>
