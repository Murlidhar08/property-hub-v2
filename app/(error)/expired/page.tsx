    ...
    return (
        <div className="h-screen w-full flex flex-col lg:flex-row select-none bg-background overflow-hidden relative">
            ...
            <motion.div
                ...
                className="flex flex-col justify-between w-full lg:w-1/2 px-6 sm:px-12 lg:px-8 py-8 relative z-10 h-full overflow-y-auto scrollbar-none bg-linear-to-b from-primary/[0.12] via-background to-background backdrop-blur-sm border-r border-border/50"
            >
                {/* LOGO + BRAND */}
                <motion.div
                ...
                <div className="flex flex-col justify-center max-w-md mx-auto w-full py-8 lg:py-0">
                    <motion.div variants={itemVariants} className="mb-8 text-center lg:text-left">
                        <div className="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center mb-6 mx-auto lg:mx-0 shadow-inner">
                            <Link2Off className="w-8 h-8 text-primary animate-pulse" />
                        </div>
                        <h2 className="text-3xl font-black tracking-tight mb-3">
                            Link Expired
                        </h2>
                        <p className="text-muted-foreground text-sm leading-relaxed font-medium">
                            The security token or access link you clicked is no longer valid. This usually happens if the link has already been used, expired due to time limits, or is malformed.
                        </p>
                    </motion.div>
            ...
            >
                ...
                <div className="relative z-10 w-full max-w-2xl text-center text-white space-y-12">
                    ...
                    >
                        ...
                        <Link2Off size={64} className="text-white relative z-10 group-hover:scale-110 transition-transform duration-500 stroke-[1.5]" />
                    </motion.div>
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-white/80 text-xl font-medium max-w-lg mx-auto leading-relaxed">
                            For security purposes, verification links are single-use and have short lifespans.
                        </p>
                    </div>
                </div>
            </motion.div>
