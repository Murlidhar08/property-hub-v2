                ...
                <div className="flex flex-col justify-center max-w-md mx-auto w-full py-8 lg:py-0">
                    <motion.div variants={itemVariants} className="mb-8 text-center lg:text-left">
                        ...
                        <p className="text-muted-foreground text-sm leading-relaxed font-medium">
                            Hold up! You don't have the required administrative role or security permissions (403 Forbidden) to access this directory or resource.
                        </p>
                    </motion.div>
            ...
            >
                ...
                <div className="relative z-10 w-full max-w-2xl text-center text-white space-y-12">
                    ...
                    >
                        ...
                        <Lock size={64} className="text-white relative z-10 group-hover:scale-110 transition-transform duration-500 stroke-[1.5]" />
                    </motion.div>
                    ...
                    <div className="space-y-6">
                        ...
                        <p className="text-white/80 text-xl font-medium max-w-lg mx-auto leading-relaxed">
                            This resource requires higher security clearance or a different administrative level.
                        </p>
                    </div>
                </div>
            </motion.div>
