...
export default function RequirementAddForm() {
    ...
    const { register, handleSubmit, setValue, watch, formState: { errors } } = useForm<RequirementFormValues>({
        ...
        defaultValues: {
            ...
            propertyForType: PropertyStatus.buy,
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 pb-24">
                ...
                <Card className="p-6 rounded-[2rem] border-border bg-card shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(val) => setValue("propertyType", val as PropertyType)} defaultValue={PropertyType.agricultural}>
                        ...
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(val) => setValue("propertyForType", val as PropertyStatus)} defaultValue={PropertyStatus.buy}>
                                <SelectTrigger className="rounded-xl h-12 w-full">
                ...
                <Card className="p-6 rounded-[2rem] border-border bg-card shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(val) => setValue("measurementType", val as MeasurementType)} defaultValue={MeasurementType.sqfoot}>
                                <SelectTrigger className="rounded-xl h-12 w-full">
                ...
                <Card className="p-6 rounded-[2rem] border-border bg-card shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(val) => setValue("clientId", val as string)}>
                                <SelectTrigger className="rounded-xl h-12 w-full">
                        ...
                        <div className="space-y-2">
                            ...
                            <Select onValueChange={(val) => setValue("agentId", val as string)}>
                                <SelectTrigger className="rounded-xl h-12 w-full">
            ...
            <FooterButtons>
                ...
                <Button type="submit" className="rounded-full px-12 h-12 font-black shadow-lg shadow-primary/20" disabled={loading}>
                    {loading ? "Adding..." : "Post Requirement"}
                </Button>
            </FooterButtons>
        </form>
    );
